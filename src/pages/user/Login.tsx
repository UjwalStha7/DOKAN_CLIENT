...
import facebookR from '../../media/facebookR.png';
...
function Login() {
    ...
    return (
        /* PARENT: min-h-screen + overflow-y-auto so short viewports SCROLL instead of clipping the card */
        <div
            style={{
            ...
            <div className="relative w-full max-w-85 sm:max-w-sm">
                ...
                <div className="relative w-full bg-linear-to-b from-[#dff2ff] via-white to-white shadow-[0_10px_40px_rgb(0,0,0,0.10)] rounded-[1.75rem] sm:rounded-4xl px-5 py-6 sm:px-9 sm:py-9">
                    ...
                    <div className="mx-auto w-10 h-10 sm:w-12 sm:h-12 bg-white rounded-2xl shadow-sm flex items-center justify-center mb-3 sm:mb-4 border border-gray-100">
                        <img className="h-4 w-4 sm:h-5 sm:w-5 opacity-80" src={login} alt="Login Icon" />
                    </div>
                    ...
                    <div className="text-center mb-5 sm:mb-6">
                        ...
                        <p className="text-[11px] sm:text-xs text-gray-500 font-medium px-1 leading-relaxed">
                            Welcome back{user?.username ? `, ${user.username}` : ''}! Access your cart, track orders, and discover products.
                        </p>
                    </div>
                    ...
                    <form className="space-y-2.5 sm:space-y-3" onSubmit={handleSubmit}>
                        ...
                        <div className="flex justify-end">
                            <Link to="/forget-password" className="text-[11px] sm:text-xs font-medium text-gray-500 hover:text-gray-900">
                                Forgot password?
                            </Link>
                        </div>
                    ...
                    <div className="relative flex items-center py-3 sm:py-4">
                        ...
                        <span className="shrink-0 mx-3 sm:mx-4 text-[9px] sm:text-[10px] font-semibold text-gray-400 tracking-wider">
                            Or sign in with
                        </span>
                        <div className="grow border-t border-dashed border-gray-200"></div>
                    </div>
                    ...
                    <div className="flex justify-center gap-3">
                        <button type="button" className="flex items-center justify-center w-16 h-9 sm:w-20 sm:h-10 bg-white rounded-xl shadow-sm border border-gray-200 hover:bg-gray-50 transition-colors">
                            <img src={google} alt="Google" className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                        </button>
                        <button type="button" className="flex items-center justify-center w-16 h-9 sm:w-20 sm:h-10 bg-white rounded-xl shadow-sm border border-gray-200 hover:bg-gray-50 transition-colors">
                            <img src={facebookR} alt="Facebook" className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                        </button>
                    </div>
